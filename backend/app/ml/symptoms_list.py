"""
Complete list of all 132 symptoms supported by the system
"""
...
# Formatted symptom names for display
SYMPTOM_DISPLAY_NAMES = {symptom: symptom.replace("_", " ").title() for symptom in SYMPTOMS_LIST}
